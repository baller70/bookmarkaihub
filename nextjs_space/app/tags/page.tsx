        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">{tags[0]?.name || "N/A"}</p>
                </div>
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Active Tags</p>
                  <p className="text-2xl font-bold">{tags.filter(t => t._count?.bookmarks > 0).length}</p>
                </div>
            ...
            <Card className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Unused Tags</p>
                  <p className="text-2xl font-bold">{tags.filter(t => !t._count?.bookmarks || t._count.bookmarks === 0).length}</p>
                </div>
              ...
              {filteredTags.map((tag) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600">
                    <p className="mb-2">{tag._count?.bookmarks || 0} bookmarks</p>
                    <div
